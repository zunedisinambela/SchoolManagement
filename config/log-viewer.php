...
use App\Http\Middleware\AuthorizeLogViewerWrites;
...
return [
    ...
    */
    ...
    /*
     * Diarahkan ke /admin, bukan ke APP_URL. Panel admin adalah satu-satunya
     * UI di aplikasi ini, dan `/` masih halaman welcome bawaan Laravel —
     * mengembalikan orang ke sana bukan "kembali ke sistem".
     */
    'back_to_system_url' => rtrim((string) config('app.url'), '/').'/admin',

    'back_to_system_label' => 'Kembali ke Panel Admin',
    ...
    */
    ...
    /*
     * AuthorizeLogViewerWrites ditambahkan repo ini, dan urutannya penting:
     * ia berjalan SETELAH AuthorizeLogViewer, jadi pengunjung yang tidak
     * berhak membaca ditolak lebih dulu dan tidak pernah sampai ke sana.
     *
     * Paketnya cuma punya satu gerbang (`viewLogViewer`) untuk seluruh API,
     * termasuk rute yang menghapus berkas log. Kelas itu memisahkannya:
     * membaca butuh View:LogViewer, menghapus butuh Delete:LogFile.
     */
    'api_middleware' => [
        EnsureFrontendRequestsAreStateful::class,
        AuthorizeLogViewer::class,
        AuthorizeLogViewerWrites::class,
    ],
    ...
    */
    ...
    /*
     * Hanya log aplikasi. Bawaan paket juga memuat /var/log/nginx dan
     * /var/log/httpd, dan itu memperluas permukaannya diam-diam: access log
     * web server berisi IP dan URL lengkap setiap pengunjung — data yang tidak
     * ada di log Laravel dan tidak pernah diminta siapa pun di sini.
     *
     * Kalau memang perlu, kembalikan barisnya secara sadar; formatnya
     * `'/var/log/nginx/*' => 'Nginx'`, dengan nilai sebagai nama folder di UI.
     * Ingat juga prosesnya harus punya izin baca ke sana — PHP-FPM biasanya
     * tidak, dan gejalanya berupa folder kosong, bukan error.
     */
    'include_files' => [
        '*.log',
        '**/*.log',
